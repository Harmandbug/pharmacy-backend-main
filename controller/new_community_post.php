...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$statment = $connect->prepare(
		'INSERT INTO community_posts (post_id,post_title,post_description,post_tag,post_featured,post_status,post_date,post_image) VALUES (null, :post_title, :post_description, :post_tag, :post_featured, :post_status, CURRENT_TIME, :post_image)'
		);
	...
	header('Location:' . SITE_URL . '/controller/community_posts.php');
