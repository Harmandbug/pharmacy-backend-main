 ...
 <div class="content sm-gutter">
            <div class="container-fluid padding-25 sm-padding-10">
                <div class="row">
                    ...
                    <h5 class="text-truncate">Edit Community Post</h5>
                </div>
                    </div>
...
<input type="hidden" value="<?php echo $post['post_id']; ?>" name="post_id">
   ...
   <textarea value="" name="post_description" class="advancedtinymce form-control" id="description" required=""><?php echo $post['post_description']; ?></textarea>
...
if (strpos($in, $post['post_status']) !== false) {
    echo '<div class="radio radio-success"> <input type="radio" name="post_status" id="radio5" value="'. $post['post_status'] .'" checked=""> <label for="radio5"> Active </label> </div>';
}else{
  echo '<div class="radio radio-success"> <input type="radio" name="post_status" id="radio5" value="' . $in .'"> <label for="radio5"> Active </label> </div>';
}
                         ?>
                        </div>
...
if (strpos($out, $post['post_status']) !== false) {
    echo '<div class="radio radio-danger"> <input type="radio" name="post_status" id="radio6" value="0" checked=""> <label for="radio6"> Inactive </label> </div>';
}else{
  echo '<div class="radio radio-danger"> <input type="radio" name="post_status" id="radio6" value="'. $out .'"> <label for="radio6"> Inactive </label> </div>';
}
                         ?>
                        </div>
